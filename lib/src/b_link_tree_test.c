...
void test_insert() {
    ...
    println(node_to_string(&fourth));
    node fifth;
    read_node(&fifth, fourth.link_ptr);
    println(node_to_string(&fifth));
    println(str("--------------------------------------------"));
    insert(17, 170);
    read_header(&h);
    read_node(&root, h.root_loc);
    ...
    read_node(&first, root.children[0]);
    println(node_to_string(&first));
    read_node(&second, first.children[0]);
    println(node_to_string(&second));
    read_node(&third, second.link_ptr);
    println(node_to_string(&third));
    read_node(&fourth, third.link_ptr);
    println(node_to_string(&fourth));
    read_node(&fifth, first.link_ptr);
    println(node_to_string(&fifth));
    node sixth;
    read_node(&sixth, fifth.children[0]);
    println(node_to_string(&sixth));
    destroy_index();
}
